...
class Ventana(tk.Tk):
    def __init__(self):
        ...
        self.menu.add_command(label="Ver reporte", command=self.ver)
    ...
    def ver(self):
        archivo_dot = 'digraph.gv'
        grafo = pgv.AGraph(archivo_dot)

    # Genera el archivo PNG a partir del grafo
        archivo_png = 'grafo.png'
        grafo.draw(archivo_png, format='png', prog='gv')

        print(f"Archivo PNG generado: {archivo_png}")
